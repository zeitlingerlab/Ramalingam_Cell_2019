...
ggplot(rnaseq,aes(group,log2FoldChange,fill=group))+geom_boxplot()+ylim(c(-2.5,2))+theme_cowplot()
...
ggplot(rnaseq2,aes(group,log2FoldChange,fill=group))+geom_boxplot()+ylim(c(-3,2))+theme_cowplot()
