...
options(knitr.figure_dir = "single_cell/")
...
```{r plot, fig.width=24, fig.height=20,dev=c("png","CairoPDF")}

wt.data<-Read10X(data.dir = "/singlecell_data/processed/MOLNG-2093/outs/filtered_gene_bc_matrices/dm6.Ens_84/")
mut.data<-Read10X(data.dir = "/singlecell_data/processed/MOLNG-2151/outs/filtered_gene_bc_matrices/dm6.Ens_84/")
...
TSNEPlot(object = embryos, group.by = "condition", do.return = TRUE, pt.size = 2, do.label=TRUE,label.size = 8,no.legend = TRUE) + theme_cowplot()

TSNEPlot(object = embryos, do.return = TRUE, pt.size = 2, do.label=TRUE,label.size = 8, no.legend = TRUE) + theme_cowplot()
