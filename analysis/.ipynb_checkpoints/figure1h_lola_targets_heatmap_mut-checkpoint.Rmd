...
options(knitr.figure_dir = "figure1h_lola_targets_heatmap_mut")
...
``` {r samples_table}
samples.df <- read.csv("data/figure1h_lola_targets_heatmap_data.csv", stringsAsFactors=FALSE)
samples.df %>% pander
```
...
build_heatmap_plot <- function(i,groups,enrichments.df) {
  ...
  heatmap.df$time %<>% factor(levels=c("wt","mut","rescue"))
