...
options(knitr.figure_dir = "figure1d_single_region_examples_polII_data_wt")
...
bw_files<-read.table("data/figure1d_single_region_examples_polII_data_wt.csv",header=TRUE,sep=",")

regions.df<-read.table("data/figure1d_single_region_examples_polII_regions_wt.csv",header=TRUE,sep=",")
regions.df
...
regions.df$fb_gene_id %>% lapply(plot_gviz_tracks,regions.df,bw_files,motif_g_match,highlight=TRUE)


bw_files<-read.table("data/figure1d_single_region_examples_polII_data_wt_zoom.csv",header=TRUE,sep=",")

regions.df<-read.table("data/figure1d_single_region_examples_polII_regions_wt_zoom.csv",header=TRUE,sep=",")
regions.df
