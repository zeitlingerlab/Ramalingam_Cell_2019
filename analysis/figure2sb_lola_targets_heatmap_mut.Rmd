...
options(knitr.figure_dir = "figure2sb_lola_targets_heatmap_mut")
...
``` {r samples_table}
samples.df <- read.csv("data/figure2sb_lola_targets_heatmap_data.csv", stringsAsFactors=FALSE)
samples.df %>% pander
```
...
build_heatmap_plot <- function(i,groups,enrichments.df) {
  ...
  heatmap.df$time %<>% factor(levels=c("wt_14-17h","orc4_14-17h","orc4_17-20h","ore50_14-17h"))
