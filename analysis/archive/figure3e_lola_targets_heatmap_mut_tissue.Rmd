...
options(knitr.figure_dir = "figure3e_lola_targets_heatmap_mut_tissue")
...
``` {r samples_table}
samples.df <- read.csv("data/figure3e_lola_targets_heatmap_data.csv", stringsAsFactors=FALSE)
samples.df %>% pander
```
