...
options(knitr.figure_dir = "figure3c_lola_targets_polII_heatmap_tissues")
...
samples.df <- read.csv("data/figure3c_lola_targets_polII_heatmap_tissues.csv", stringsAsFactors=FALSE)
samples.df %>% pander
