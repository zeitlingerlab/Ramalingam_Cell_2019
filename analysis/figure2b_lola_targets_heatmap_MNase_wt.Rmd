...
options(knitr.figure_dir = "figure2b_lola_targets_heatmap_MNase_wt")
...
``` {r samples_table}
samples.df <- read.csv("data/figure2b_lola_targets_heatmap_MNase_wt.csv", stringsAsFactors=FALSE)
samples.df %>% pander
```
...
build_heatmap_plot <- function(i,groups,enrichments.df) {
  ...
  heatmap.df$time %<>% factor(levels=c("wt_2-4h","wt_14-17h"))
