...
options(knitr.figure_dir = "figure1d_bound_genes_expression")
...
lola_bound_genes<-readRDS("figure1e_lola_targets_heatmap/groups.rds")$lola_targets
control_genes<-readRDS("figure1e_lola_targets_heatmap/groups.rds")$control

FPKM.df$class<-'others'
FPKM.df$class[FPKM.df$fb_tx_id %in% lola_bound_genes]<-'Lola_targets'
FPKM.df$class[FPKM.df$fb_tx_id %in% control_genes]<-'control'
