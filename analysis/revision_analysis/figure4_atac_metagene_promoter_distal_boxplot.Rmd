...
options(knitr.figure_dir = "figure4_atac_metagene_promoter_distal_boxplot")
...
atac_14_17.cov<- ((import("../../bw/dme_emb_orer_14_17h_atac_8.bam_from0to100_rpm.bw") %>% {coverage(.,weight=.$score)})+(import("../../bw/dme_emb_orer_14_17h_atac_8.bam_from0to100_rpm.bw") %>% {coverage(.,weight=.$score)}))/2
atac_mut_14_17.cov<- ((import("../../bw/dme_emb_28267_14_17h_atac_2.bam_from0to100_rpm.bw") %>% {coverage(.,weight=.$score)})+(import("../../bw/dme_emb_act_lola_PI_28267_14_17h_atac_2.bam_from0to100_rpm.bw") %>% {coverage(.,weight=.$score)}))/2

atac_lst<-list(atac_14_17=atac_14_17.cov,atac_mut_14_17=atac_mut_14_17.cov)
...
lola_peaks.gr$atac_wt_14_17h<-regionSums(lola_peaks.gr, atac_14_17.cov)
lola_peaks.gr$atac_mut_14_17h<-regionSums(lola_peaks.gr, atac_mut_14_17.cov)
