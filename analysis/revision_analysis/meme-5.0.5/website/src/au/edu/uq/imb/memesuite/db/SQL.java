...
public final class SQL {
  ...
  /** Create a table to store information about a CisMapper database */
  public static final String CREATE_TBL_CISMAPPER =
    "CREATE TABLE tblCismapper (\n" +
    ...
    "  histone_names TEXT NOT NULL,\n" +
    "  max_link_distances TEXT NOT NULL,\n" +
    "  expression_root TEXT NOT NULL,\n" +
    "  expression_file_type TEXT NOT NULL,\n" +
  ...
  /** Insert a row describing cismapper input files */
  public static final String INSERT_CISMAPPER_DB =
    "INSERT INTO tblCismapper\n" +
    "  (listingId, genome_release, rna_source, tissues,\n" +
    "      histone_root, histone_names, max_link_distances,\n" +
  ...
  public static final String SELECT_CISMAPPER_LISTINGS_OF_CATEGORY =
    "SELECT id, name, description, 0, 0, genome_release, rna_source, tissues, histone_root, \n" +
    "    histone_names, max_link_distances, expression_root, expression_file_type, \n" +
    "    annotation_file_name, annotation_type, transcript_types\n" +
    "FROM tblListing as l\n" +
    "  INNER JOIN tblCismapper AS g ON l.id = g.listingId\n" +
    "WHERE l.categoryId = ?";
 ...
 public static final String SELECT_ALL_OBSOLETE_SEQUENCE_FILES =
  ...
  public static final String SELECT_CISMAPPER_LISTING =
