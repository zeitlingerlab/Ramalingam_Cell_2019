...
options(knitr.figure_dir = "gaf_targets")
...
import("/lola_paper/aws/bed/gaf_14_17h/gaf_peaks_14_17h_1_summits.bed") %>% resize(fix='center',width=200) ->peaks_1.gr   
...
get_peaks_frequency<-function(number=1000,bw1= "/lola_paper/aws/bed/gaf_14_17h/gaf_peaks_14_17h_1_summits.bed", promoter_width =500,upstream=50){
