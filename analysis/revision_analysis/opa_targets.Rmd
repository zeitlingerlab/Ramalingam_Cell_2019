...
options(knitr.figure_dir = "opa_targets")
...
import("/lola_paper/aws/external_data/GSE140722_GSM4182505/opa_peaks_1_summits.bed") %>% resize(fix='center',width=200) ->peaks_1.gr   
...
get_peaks_frequency<-function(number=1000,bw1= "/lola_paper/aws/external_data/GSE140722_GSM4182505/opa_peaks_1_summits.bed", promoter_width =500,upstream=50){
...
# Calculating freqency of Opa binding at promoters
